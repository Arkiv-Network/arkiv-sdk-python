...
def test_manual_cleanup_filters(arkiv_client_http):
    ...
    # Create filters
    filter1 = arkiv_client_http.arkiv.watch_entity_created(callback, from_block="latest")
    filter2 = arkiv_client_http.arkiv.watch_entity_created(callback, from_block="latest")
